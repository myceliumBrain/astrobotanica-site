...
function getVerbeteSlugFromPath() {
...
const loadEstudos = () => loadJSON("data/estudos.json");
const loadCategoriasEstudo = () => loadJSON("data/categorias_estudo.json");
...
function findCategoriaEstudo(categorias, id) {
    return categorias.find((c) => c.id === id);
}

function buildVerbeteCard(verbete, categoria) {
    const card = document.createElement("a");
...
function renderEstudosIndex(estudos, categorias) {
    ...
    const search = document.getElementById("estudos-search");
    if (search) {
...
function renderVerbeteDetail(estudos, categorias) {
